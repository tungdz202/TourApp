...
import ButtonFilter from "../../../components/ButttonCustom/ButtonFilter/ButtonFilter";
      ...
      >
        ...
        <Box>
          ...
          >
            ...
            <Box sx={{ display: "flex", flexDirection: "row" }}>
              <div onClick={handleSortNone}>
                <ButtonFilter text={"Giá gốc"} />
              </div>
              <div onClick={handleSortDesc}>
                <ButtonFilter text={"Giảm dần"} />
              </div>
              <div onClick={handleSortAsc}>
                <ButtonFilter text={"Tăng dần"} />
              </div>
            </Box>
          </Box>
        </Box>
...
const rangePrices = [
  ...
  {
    name: "Dưới 1.000.000 vnd ",
    minprice: 0,
    maxprice: 1000000,
  },
  {
    name: "Dưới 2.000.000 vnd ",
    minprice: 0,
    maxprice: 2000000,
  },
  {
    name: "Dưới 3.000.000 vnd ",
    minprice: 0,
    maxprice: 3000000,
  },
  {
    name: "Dưới 5.000.000 vnd ",
    minprice: 0,
    maxprice: 5000000,
  },
  {
    name: "Dưới 7.000.000 vnd ",
    minprice: 0,
    maxprice: 7000000,
  },
  {
    name: "Dưới 9.000.000 vnd ",
    minprice: 0,
    maxprice: 9000000,
  },
  {
    name: "Dưới 10.000.000 vnd ",
    minprice: 0,
    maxprice: 10000000,
  },
  {
